...
public class GossipProcessor {

    // {"type" : "gossipnewidentity", "serverid" : "ServerID", "updatedlist": []}
    public JSONObject gossip(String type, String serverid, ConcurrentHashMap<String, ClientPojo> globalClients){
    ...
    // {"type" : "gossipnewidentity", "serverid" : "ServerID", "updatedlist": []}
    public JSONObject gossipRoom(String type, String serverid, ConcurrentHashMap<String, Group> globalRooms){
        JSONObject gossip = new JSONObject();
        gossip.put("type", type);
        gossip.put("serverid", serverid);
